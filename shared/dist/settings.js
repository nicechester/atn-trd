...
export const SettingsSchema = z.object({
    ...
    signals: z.object({
        ...
        sellThreshold: z.number().min(0).max(1).default(0.25), // Below this triggers sell (was -0.50 on old [-1,1] scale)
