...
export declare function listTradesHandler(req: Request, res: Response, next: NextFunction): void;
/** GET /api/trades/pending */
export declare function listPendingOrdersHandler(_req: Request, res: Response, next: NextFunction): void;
/** POST /api/trades/pending/:id/cancel */
export declare function cancelPendingOrderHandler(req: Request, res: Response, next: NextFunction): void;
